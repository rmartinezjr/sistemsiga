...
<script>
    ...
    jQuery(function(){
        $('.fsiguiente').click( function(){
            ...
            var url = getUrl() + "viewFormDinamics/"+"<?=$_SESSION['fd_if_formdinamic']."/".$_SESSION['fd_id_entidad']."/"?>"+iddataform+"/next";
            window.location.assign(url);
        });

        $('.fanterior').click( function(){
            var idformdinamic="<?=$_SESSION['fd_if_formdinamic']?>";
            var url = getUrl() + "viewFormDinamics/"+"<?=$_SESSION['fd_if_formdinamic']."/".$_SESSION['fd_id_entidad']."/"?>"+iddataform+"/previous";
            window.location.assign(url);
        });
        ...
        $('.btn-save').click( function(){
            ...
            var url = '<?= \Cake\Routing\Router::url(['controller' => 'entidads', 'action' => 'saveallquestions'], true) ?>';
