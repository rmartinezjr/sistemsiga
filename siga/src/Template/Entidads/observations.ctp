...
<script>
    ...
    jQuery(function(){
        $('.fsiguiente').click( function(){
            ...
            var url = getUrl() + "observations/"+"<?=$_SESSION['fd_if_formdinamic']."/".$_SESSION['fd_id_entidad']."/"?>"+iddataform+"/next";
            window.location.assign(url);
        });

        $('.fanterior').click( function(){
            var idformdinamic="<?=$_SESSION['fd_if_formdinamic']?>";
            var url = getUrl() + "observations/"+"<?=$_SESSION['fd_if_formdinamic']."/".$_SESSION['fd_id_entidad']."/"?>"+iddataform+"/previous";
            window.location.assign(url);
        });
