 ...
 * @var \App\Model\Entity\Entidadred[]|\Cake\Collection\CollectionInterface $entidadreds
 */
    ...
    <div class="cont-border">
        ...
        <div class="row">
            <div class="col-md-12 content-form">
                ...
                <div class="col-md-2 frm-label no-disponible" <?= $estilo_no_disponible ?>>Documento no Disponible</div>
                <div class="col-md-2 no-disponible" <?= $estilo_no_disponible ?>>
                ...
                <div class="col-md-5">
                    <div class="col-md-10 col-sm-8 col-xs-10 entidadsrelated">
                        <?php if(count($entidadreds) > 0) { ?>
                            <?php $i = 0 ?>
                            <?php foreach($entidadreds as $entidadmiembro) { ?>
                                <div id="bloque-entidad-select-<?= $i ?>" class="col-md-11 col-sm-8 col-xs-8 bloque-entidad-select">
                                    <?=$this->Form->control('entidad_'. $i,[
                                        ...
                                        'data-corr' => $i,
                                        'id' => 'entidad-' . $i,
                                        'value' => $entidadmiembro->entidadhija,
...
<script>
    jQuery(function(){
        ...
        var url_entidadtipo = '<?= \Cake\Routing\Router::url(['controller' => 'entidads', 'action' => 'verifyrequireddocid'], true)  . '/' ?>';
        ...
        if(($("#nacional").val() == 1) && (!$('#docidnull').is(':checked'))) {
            getMascaraDocumento($("#nacional").val(), url, $("#docid"), true);
        } else if($('#docidnull').is(':checked')) {
            $("#docid").val('');
        } else {
