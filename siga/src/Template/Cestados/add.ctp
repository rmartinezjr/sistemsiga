    ...
    <div class="cont-border">
        ...
        <div class="row">
            ...
            <div class="col-md-12 content-form">
                ...
                <div class="col-md-3">
                    <input type="hidden" name="colorbkg" id="colorbkg" >
                    <div id="cp1" class="input-group colorpicker-component">
                        <input type="text" name="bkg" id="bkg" value="#FFFFFF"  class="form-control"  style="margin-bottom: inherit;"/>
                ...
                <div class="col-md-3">
                    <div id="cp2" class="input-group colorpicker-component">
                        <input type="text" name="colortext" id="colortext" value="#000000" class="form-control" style="margin-bottom: inherit;"/>
                ...
                <div class="col-md-2">
                    <div class="cjestado" style="padding: 3px 10px; word-wrap: break-word; border-radius: 3px;width: 95px;
                            text-align: center;min-height: 25px;"><span id="spestado" style="font-size: 12px;"></span></div>
                </div>
                <div class="clearfix col-md-12" style="margin: 4px;"></div>
