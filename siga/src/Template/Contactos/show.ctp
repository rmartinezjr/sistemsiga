...
<script>
    ...
    jQuery(function(){
        $('.fsiguiente').click( function(){
            ...
            var url = getUrl() + "show/"+"<?=$_SESSION['fd_if_formdinamic']."/".$_SESSION['fd_id_contacto']."/"?>"+iddataform+"/next";
            window.location.assign(url);
        });

        $('.fanterior').click( function(){
            var idformdinamic="<?=$_SESSION['fd_if_formdinamic']?>";
            var url = getUrl() + "show/"+"<?=$_SESSION['fd_if_formdinamic']."/".$_SESSION['fd_id_contacto']."/"?>"+iddataform+"/previous";
            window.location.assign(url);
        });
