    ...
    <div class="cont-border">
        ...
        <div class="row">
            <?php if(strlen("Tipo de Contacto: ".$contacto->ccontactotipo->nombre)>20):?>
                <div class="col-md-6">
                    ...
                    <div class="col-md-3 state-struct text-center" style="background-color:<?php $contacto->cestado->colorbkg?>; color:<?php $contacto->cestado->colortext?>;">
                        <?= $contacto->cestado->nombre ?>
                    </div>
                </div>
            ...
            <?php else: ?>
                <div class="col-md-4">
                    ...
                    <div class="col-md-4 state-struct text-center" style="background-color:<?php $contacto->cestado->colorbkg?>; color:<?php $contacto->cestado->colortext?>;">
                        <?= $contacto->cestado->nombre ?>
                    </div>
                </div>
        ...
        <div class="row m-b-20">
            ...
            <div class="col-md-6 info-log">
                <span class="lbl">Creado:</span><span class="lbl-data"><?=$contacto->usuario." (".date("d-m-Y H:i:s", strtotime($contacto->created)).")"?></span>
                <?php if($contacto->usuariomodif!=''){ ?>
                    <br>
                    <span class="lbl">Última Modificación:</span><span class="lbl-data"><?=$contacto->usuariomodif." (".date("d-m-Y H:i:s", strtotime($contacto->modified)).")"?></span>
                <?php          }   ?>
            </div>
        </div>
        <?php if($datos['resp']):?>
                    ...
                    <?php if(count($datos['seccionHijo'])>0): ?>
                        ...
                        <div class="col-md-12 col-xs-12 fila-data p-0">
                            <div class="col-md-12 col-xs-12 col-label struct-border-end color-struct-contet">
                                ...
                                <?php // debug(count($datos['formpreguntas']))  ?>
